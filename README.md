...
# Porcupine Wake Word Engine Demo for PSOC6
...
3. Copy the contents of the `KEYWORD_ARRAY` array inside the `.h` header file and update the `DEFAULT_KEYWORD_ARRAY` value in [/include/pv_params.h](./include/pv_params.h)
